...
public class ColFixTableAdapter<T> extends BaseTableAdapter {
	...
	public ColFixTableAdapter(Context context) {
		this(context, null);
	}

	public ColFixTableAdapter(Context context, T[][] table) {
	...
	public View getView(int row, int column, View convertView, ViewGroup parent) {
		...
		((TextView) convertView).setText(table[row + 1][column].toString());
		return convertView;
	}
